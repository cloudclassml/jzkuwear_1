...
class AvatarMediumSquare extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle user-avatar-circle-flat medium ${!this.props.data.rank ? 'no-stats' : ''} ${this.noBorderClasses} ${this.props.modifiers || ''}`}
        ...
        this.props.data.rank &&
          <React.Fragment>
            ...
            <div className="user-avatar-circle-progress">
              <SquareProgressBar size="medium" fillAmount={this.props.data.rank.current / this.props.data.rank.total} />
            </div>
            {/* USER AVATAR CIRCLE PROGRESS */}
...
module.exports = AvatarMediumSquare;