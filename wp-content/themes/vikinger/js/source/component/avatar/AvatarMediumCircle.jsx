...
class AvatarMediumCircle extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle medium ${!this.props.data.rank ? 'no-stats' : ''} ${this.noBorderClasses} ${this.props.modifiers || ''}`}
...

      {
        this.props.data.rank &&
          <React.Fragment>
            ...
            <CircleProgressBar size="medium" fillAmount={this.props.data.rank.current / this.props.data.rank.total} />
            {/* USER AVATAR CIRCLE PROGRESS */}
...
module.exports = AvatarMediumCircle;