...
class AvatarMicroCircle extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle micro ${this.noBorderClasses} ${this.props.modifiers || ''}`}
...
module.exports = AvatarMicroCircle;