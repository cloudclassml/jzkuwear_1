...
class AvatarCircle extends React.Component {
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle ${!this.props.data.rank ? 'no-stats' : ''} ${this.noBorderClasses} ${this.props.modifiers || ''}`}
...

      {
        this.props.data.rank &&
          <React.Fragment>
            ...
            <CircleProgressBar size="regular" fillAmount={this.props.data.rank.current / this.props.data.rank.total} />
            {/* USER AVATAR CIRCLE PROGRESS */}
