...
class AvatarMicroSquare extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle user-avatar-circle-flat micro ${this.noBorderClasses} ${this.props.modifiers || ''}`}
...
module.exports = AvatarMicroSquare;