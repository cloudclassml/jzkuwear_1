...
class AvatarOverlaySmallerCircle extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Element  className={`user-avatar-circle smaller ${this.noBorderClasses} ${this.props.modifiers || ''}`}
...
module.exports = AvatarOverlaySmallerCircle;