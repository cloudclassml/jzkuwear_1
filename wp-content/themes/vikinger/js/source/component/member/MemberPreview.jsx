      ...
      {/* USER PREVIEW FOOTER */}
      {
        vikinger_constants.plugin_active.buddypress_friends &&
          <div className="user-preview-footer">
              ...
              this.props.loggedUser && (this.props.loggedUser.id !== this.props.data.id) &&
                <React.Fragment>
                {
                  !friendable.isFriend() && !friendable.friendRequestSent() && !friendable.friendRequestReceived() &&
                    <AddFriendButton  modifiers="void void-secondary"
                                      icon="add-friend"
      ...
      
                {
                  !friendable.isFriend() && friendable.friendRequestSent() &&
                    <WithdrawFriendRequestButton  modifiers="void void-tertiary"
                                                  icon="remove-friend"
      ...
      
                {
                  !friendable.isFriend() && friendable.friendRequestReceived() &&
                    <AcceptFriendRequestButton  modifiers="void void-secondary"
                                                icon="add-friend"
                ...
                {
                  friendable.isFriend() &&
                    <RemoveFriendButton modifiers="void void-tertiary"
                                        icon="remove-friend"
            ...
            <div className="user-preview-footer-action">
            {
              vikinger_constants.plugin_active.buddypress_messages && this.props.loggedUser && (this.props.loggedUser.id !== this.props.data.id) && friendable.isFriend() &&
                <ButtonLink modifiers="void void-primary"
