...
class MemberFilterBar extends React.Component {
  constructor(props) {
    super(props);
            ...
            <div className="form-row split">
            {
              ...
              <div className="form-item">
                <div className="form-select">
                  ...
                  <select id="member-order-by" name="type" value={this.state.type} onChange={this.handleChange}>
...
module.exports = MemberFilterBar;