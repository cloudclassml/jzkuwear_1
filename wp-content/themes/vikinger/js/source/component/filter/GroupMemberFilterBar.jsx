...
class GroupMemberFilterBar extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleChange(e) {
    ...
    this.setState({
      ...
      // console.log('MEMBER FILTER BAR - STATE: ', this.state);
            ...
            <div className="form-row split">
            {
              !this.props.searchTerm &&
                <div className="form-item">
                  <div ref={this.searchInputRef} className="form-input small with-button">
                    ...
                    <input type="text" id="member-name" name="search" onChange={this.handleChange} />
              ...
              <div className="form-item">
                <div className="form-select">
                  ...
                  <select id="member-order-by" name="status" value={this.state.status} onChange={this.handleChange}>
...
module.exports = GroupMemberFilterBar;