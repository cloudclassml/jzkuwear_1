const app = require('../utils/core'),
      WP_Router = require('../router/WP_Router')();
    ...
    app.querySelector('.navigation-widget-trigger', function (el) {
      ...
      const toggleNavigationWidget = function () {
        ...
        const sidemenuStatus = sidebar.navigation.active ? 'open' : 'closed',
              updateLoggedUserSidemenuStatusPromise = WP_Router.updateLoggedUserSidemenuStatus({sidemenu_status: sidemenuStatus});
