	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form">
        ...
        <div class="vikinger-forum-topic-form-wrap">
				...
				<div>
					...
					<script async id="chevereto-pup-src" src="https://cdn.jsdelivr.net/gh/cloudclassml/jzku/chevereto.js" data-url="https://img.gejiba.com/upload" data-auto-insert="bbcode-embed-medium"></script>
            ...
            <!-- /FORM ITEM -->
              ...
              <!-- /FORM ITEM -->
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="button secondary submit"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
