...
?>
  ...
  ?>
    ...
    <div id="post-preview-filterable-list" class="filterable-list" data-category="<?php echo esc_attr($category->cat_ID); ?>" data-grid-type="<?php echo esc_attr($posts_grid_type); ?>"></div>
    <!-- /POST PREVIEW FILTERABLE LIST -->
  </div>
  <!-- /CONTENT GRID -->
