...
<div class="vk-content">
  ...
  <div class="section">
    ...
    <?php
      ...
      echo wp_kses(
        sprintf(
          esc_html__('You can get support by contacting our support team via email, it\'s important that you follow the guidelines detailed below when sending your query to our support team, %sthis will save you time and back and forth emails%s as this information will be required by the team to be able to help you with your query:', 'vikinger'),
          '<span class="bold">',
          '</span>'
        ),
        vikinger_wp_kses_admin_text_get_allowed_tags()
    ...
    <ul class="unordered-list">
      ...
      <li class="unordered-list-item">
        ...
        <?php
          ...
          echo wp_kses(
            sprintf(
              esc_html__('Include your %spurchase code%s in the email.', 'vikinger'),
              '<strong>',
              '</strong>'
            ),
            vikinger_wp_kses_admin_text_get_allowed_tags()
      ...
      <li class="unordered-list-item">
        ...
        <?php
          ...
          echo wp_kses(
            sprintf(
              esc_html__('%sSend a detailed description of the question, feedback, suggestion, or issue you are having%s. Add screenshots if necessary to clarify what you want to describe.', 'vikinger'),
              '<strong>',
              '</strong>'
            ),
            vikinger_wp_kses_admin_text_get_allowed_tags()
    ...
    <?php
      ...
      echo wp_kses(
        sprintf(
          esc_html__('%sFollowing the above guidelines%s, send your query to our support team at: %ssupport@odindesignthemes.com%s', 'vikinger'),
          '<strong>',
          '</strong>',
          '<a href="mailto:support@odindesignthemes.com">',
          '</a>'
        ),
        vikinger_wp_kses_admin_text_get_allowed_tags()
      );
