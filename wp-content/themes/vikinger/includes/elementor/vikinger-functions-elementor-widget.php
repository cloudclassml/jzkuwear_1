...
function vikinger_elementor_widgets_register() {
  ...
  class Vikinger_Menu extends \Elementor\Widget_Base {
    ...
    protected function render() {
       ...
       * Navigation
       */
      get_template_part('includes/elementor/template-part/navigation/navigation', null, [
  ...
  class Vikinger_Menu_Mobile extends \Elementor\Widget_Base {
    ...
    protected function render() {
       ...
       * Navigation Mobile
       */
      get_template_part('includes/elementor/template-part/navigation/navigation-mobile', null, [
