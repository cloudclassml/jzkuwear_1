<?php
/**
 * Vikinger TRANSLATION functions
 * 
 * @since 1.0.0
 */
...
function vikinger_translation_get() {
  return [
     ...
     * Header Search
     */
    'search_placeholder'              => esc_html__('Search here for', 'vikinger'),
    ...
    'no_posts_found'                  => esc_html__('No posts found', 'vikinger'),
     ...
     * Filterable List
     */
    'item_list_no_results_title'  => esc_html__('No items found', 'vikinger'),
    'item_list_no_results_text'   => esc_html__('Please try with another filter!', 'vikinger'),

    'activity_no_results_title'   => esc_html__('No posts found', 'vikinger'),
    'activity_no_results_text'    => esc_html__('Please try with another filter!', 'vikinger'),
