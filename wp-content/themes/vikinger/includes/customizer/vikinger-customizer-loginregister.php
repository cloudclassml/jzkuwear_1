...
function vikinger_customizer_loginregister($wp_customize) {
   ...
   */
  $wp_customize->add_setting('vikinger_loginregister_setting_redirect', [
    'sanitize_callback' => 'sanitize_text_field',
    'default'           => ''
  ]);

  $wp_customize->add_control('vikinger_loginregister_control_redirect', [
    'label'           => esc_html_x('Login - Redirect Page', '(Customizer) Login Option - Redirect Page - Title', 'vikinger'),
    'description'     => esc_html_x('You can choose which page users are redirected to when they login to the site (home page is used by default).', '(Customizer) Login Option - Redirect Page - Description', 'vikinger'),
    'type'            => 'dropdown-pages',
    'allow_addition'  => false,
    'section'         => 'vikinger_loginregister',
    'settings'        => 'vikinger_loginregister_setting_redirect',
  ]);

  /**
   * Login Register Exceptions
   */
  $wp_customize->add_setting('vikinger_loginregister_setting_exceptions', [
    'sanitize_callback' => 'vikinger_customizer_sanitize_array',
    'default'           => []
  ]);

  $wp_customize->add_control(new WP_VK_MultiSelect_Control($wp_customize, 'vikinger_loginregister_control_exceptions', [
    'label'           => esc_html_x('Force Login - Exceptions', '(Customizer) Force Login Option - Exceptions - Title', 'vikinger'),
    'description'     => esc_html_x('You can choose pages that can still be accessible when the force login option is enabled.', '(Customizer) Force Login Option - Exceptions - Description', 'vikinger'),
    'type'            => 'vk_multiselect',
    'section'         => 'vikinger_loginregister',
    'settings'        => 'vikinger_loginregister_setting_exceptions',
  ]));
